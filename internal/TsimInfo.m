...
% Copyright (c) 2013-20, Deborah Meyer, Till Biskup
% 2020-12-14
...
info.url = 'http://till-biskup.de/en/software/matlab/tsim/';
info.bugtracker = struct(...
    'type','github',...
    'url','https://github.com/tillbiskup/matlab-trepr-tsim/issues'...
    );
info.vcs = struct(...
    'type','git',...
    'url','https://github.com/tillbiskup/matlab-trepr-tsim'...
    );
info.description = ...
